...
@frappe.whitelist()
def download_pdf(doctype, name, name_concat="", format=None, doc=None, no_letterhead=0):
	html = frappe.get_print(doctype, name, format, doc=doc, no_letterhead=no_letterhead)
	frappe.local.response.filename = "{name}-{name_concat}.pdf".format(name=name.replace(" ", "-").replace("/", "-"), name_concat=name_concat)
